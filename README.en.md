...
# Spears 🗡️ (Minecraft 1.21.4 Fabric Port)
...
### Features:
- 🗡️ **Extended Attack Reach**: Spears allow attacking targets at increased reach (2.0 – 4.5 blocks).
...
## 🛠️ Changes in 1.21.4 Port (byMr712)
