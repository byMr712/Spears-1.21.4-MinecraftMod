...
### Особенности:
- 🗡️ **Увеличенная дистанция атаки (Reach)**: копья позволяют атаковать противников на увеличенной дистанции (2.0 – 4.5 блока).
...
## 🛠️ Что изменено в порте для 1.21.4 (byMr712)
